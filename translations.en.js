export const en = {
    ...
    bio_content2: `
                <div class="text-base leading-relaxed space-y-4">
                    ...
                    <div class="my-6 text-center"><img class="mx-auto max-w-md w-full rounded shadow-lg" src="images/ruy_guerra-por_lara.jpg" alt="A photo of Ruy In Mozambique sent by his sister Lara"><p class="text-sm italic mt-2">A photo of Ruy In Mozambique sent by his sister Lara</p></div>
                    ...
                    <div class="my-6 text-center"><img class="mx-auto max-w-2xl w-full rounded shadow-lg" src="images/cinema-novo_grupo.jpg" alt="Cinema Novo in Brazil"><p class="text-sm italic mt-2">Meeting of filmmakers for a the French TV programme, ‘Carnets brésiliens’, Copacabana 1966</p></div>
                    ...
                    <div class="my-6 text-center"><img class="mx-auto max-w-2xl w-full rounded shadow-lg" src="images/com-gabo.jpg" alt="Ruy Guerra and Gabriel Garca Mrquez"><p class="text-sm italic mt-2">Ruy Guerra and Gabriel García Márquez during the filming of ‘Erêndira’, Mexico, 1982</p></div>
